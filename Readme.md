...
Note: The current version is compatible with Multichain Alpha 19, released 3/31/2016. For previous versions of Multichain, see [Releases](https://github.com/scoin/multichain-node/releases).
